    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"> Blog Category
                    <a href="{{url('blog-category-create')}}" class="float-right btn btn-primary">Add</a>
                </h4>
                    ...
                    <table class="table" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $data->blog_cat_description}}
                                </td>
                                <td class="text-right">
                                    <a href="{{ url('/blog-category-edit/'.$data->id) }}"
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        var data = {
                            ...
                            $.ajax({
                                type:"DELETE",
                                url: "{{ url('blog-cate-delete')}}/"+delete_id,
                                data:data,
